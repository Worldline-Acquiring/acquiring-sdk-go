...
// Client represents a CardPayments client. Thread-safe.
type Client struct {
...
//
// Documentation can be found at https://docs.acquiring.worldline-solutions.com/api-reference#tag/Card-Payments/operation/processPayment.
//
...
//
// Documentation can be found at https://docs.acquiring.worldline-solutions.com/api-reference#tag/Card-Payments/operation/simpleCaptureOfPayment.
//
// Can return any of the following errors:
//   - ValidationError if the request was not correct and couldn't be processed (HTTP status code 400)
//   - AuthorizationError if the request was not allowed (HTTP status code 403)
...
//
// Documentation can be found at https://docs.acquiring.worldline-solutions.com/api-reference#tag/Card-Payments/operation/reverseAuthorization.
//
// Can return any of the following errors:
//   - ValidationError if the request was not correct and couldn't be processed (HTTP status code 400)
//   - AuthorizationError if the request was not allowed (HTTP status code 403)
...
//
// Documentation can be found at https://docs.acquiring.worldline-solutions.com/api-reference#tag/Card-Payments/operation/incrementPayment.
//
// Can return any of the following errors:
//   - ValidationError if the request was not correct and couldn't be processed (HTTP status code 400)
//   - AuthorizationError if the request was not allowed (HTTP status code 403)
...
// CreateRefund represents the resource /processing/v1/{acquirerId}/{merchantId}/payments/{paymentId}/refunds - Refund card payment.
//
// Documentation can be found at https://docs.acquiring.worldline-solutions.com/api-reference#tag/Card-Payments/operation/createRefund.
//
// Can return any of the following errors:
//   - ValidationError if the request was not correct and couldn't be processed (HTTP status code 400)
//   - AuthorizationError if the request was not allowed (HTTP status code 403)
...
// NewClient constructs a new CardPayments client.
//
// parent is the communicator.APIResource on top of which we want to build the new CardPayments client.
